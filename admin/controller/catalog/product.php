...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		///custom entry exchange limit
		$data['entry_exchange_price'] = "Exchange limit";
		/////////////////
		...
		/////////////custom field exchange price
		if (isset($this->request->post['exchange_price'])) {
			$data['exchange_price'] = $this->request->post['exchange_price'];
		} elseif (!empty($product_info)) {
			$data['exchange_price'] = $product_info['exchange_price'];
		} else {
			$data['exchange_price'] = '';
		}
         /////////////////////////////////
